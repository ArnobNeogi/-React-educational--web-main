                ...
                <section>
                    <div className="row">
                        ...
                        <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                            ...
                            <p><small className="text-white">About us
                            </small></p>

                            <p><small className="text-white">Contact us
                            </small></p>
                        </div>
                        ...
                        <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                            <p><small className="text-white">Careers
                            </small></p>
                            <p><small className="text-white">Blog
                            </small></p>

                            <p><small className="text-white">Help and Support
                            </small></p>

                            <p><small className="text-white">Affiliate
                            </small></p>
                        </div>
                        ...
                        <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                            <p><small className="text-white">Terms
                            </small></p>
                            <p><small className="text-white">Privacy Policy
                            </small></p>

                            <p><small className="text-white">Sitemap
                            </small></p>
                        </div>
                ...
                <section className="p-3 pt-0">
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-7 col-lg-8 text-center text-md-start">
                            <p className="mb-0">© 2021 Copyright : Application Developed By ARNOB NEOGI</p>
                        </div>
